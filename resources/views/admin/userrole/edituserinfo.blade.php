                    ...
                    <div class="widget-body">
                        ...
                        <form class="form-horizontal no-margin" action="/admin/post_edit_user" method="post">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="telphone" id="telphone" value="{{ $user->telephone }}" class="span6" placeholder="135********">
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="position" id="position" value="{{ $user->position }}" class="span6" placeholder="项目经理">
                                </div>
                            </div>
